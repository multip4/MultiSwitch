...
set_property -dict [list CONFIG.HAND_SHAKE {0} CONFIG.DATA_COUNT {2} CONFIG.DATA_1_WIDTH {32} CONFIG.DATA_2_WIDTH {32} CONFIG.FILE_PATH ${file_path_data_in}] [get_ips sim_stim_general_ip]
...
set_property -dict [list CONFIG.DATA_COUNT {1} CONFIG.DATA_0_WIDTH {1} CONFIG.FILE_PATH ${file_path_data_exp} CONFIG.LOG_FILE_PATH ${file_path_data_log}] [get_ips sim_checker_general_ip]
