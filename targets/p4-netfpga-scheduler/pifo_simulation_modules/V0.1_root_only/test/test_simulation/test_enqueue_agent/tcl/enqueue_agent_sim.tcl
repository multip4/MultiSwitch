...
# set_property -dict [list CONFIG.FILE_PATH ${file_path_data_exp} CONFIG.LOG_FILE_PATH ${file_path_data_log}][get_ips sim_checker_general_ip]
set_property -dict [list CONFIG.DATA_COUNT {2} CONFIG.DATA_0_WIDTH {5} CONFIG.DATA_1_WIDTH {5} CONFIG.FILE_PATH ${file_path_data_exp} CONFIG.LOG_FILE_PATH ${file_path_data_log}] [get_ips sim_checker_general_ip]
# reset_target all [get_ips sim_checker_general_ip]
