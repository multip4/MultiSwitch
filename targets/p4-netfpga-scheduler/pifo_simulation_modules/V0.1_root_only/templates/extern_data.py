...
# Add for PIFO Rank Extern Template.
...
"drr_calc" : {"hdl_template_file": "externs/drr_calc/hdl/EXTERN_drr_calc_template.v",
                  "replacements": {"@EXTERN_NAME@" : "extern_name",
                              "@PREFIX_NAME@" : "prefix_name",
                              "@MODULE_NAME@" : "module_name",
                              "@ADDR_WIDTH@" :  "addr_width",
...
"extern_calc" : {"hdl_template_file": "externs/extern_calc_no_cpu/hdl/EXTERN_extern_calc_template.v",
                  "replacements": {"@EXTERN_NAME@" : "extern_name",
                              "@PREFIX_NAME@" : "prefix_name",
                              "@MODULE_NAME@" : "module_name",
                              "@CLASS_WIDTH@" :  "input_width(class_id)",
                              "@ADDR_WIDTH@" :  "addr_width",
                              "@INDEX_WIDTH@" : "input_width(class_id)",
                              "@PKT_WIDTH@" :  "input_width(pkt_len)",
                              "@TYPE_WIDTH@" :  "input_width(rc_type)",
                              "@WEIGHT_WIDTH@" :  "input_width(class_weight)",
                              "@REG_WIDTH@" :   "output_width(result)",
                              "@RESULT_WIDTH@" : "output_width(result)"
...
# "extern_calc2" : {"hdl_template_file": "externs/extern_calc_no_cpu/hdl/EXTERN_extern_calc2_template.v",
#                   "replacements": {"@EXTERN_NAME@" : "extern_name",
#                               "@PREFIX_NAME@" : "prefix_name",
#                               "@MODULE_NAME@" : "module_name",
#                               "@CLASS_WIDTH@" :  "input_width(class_id)",
