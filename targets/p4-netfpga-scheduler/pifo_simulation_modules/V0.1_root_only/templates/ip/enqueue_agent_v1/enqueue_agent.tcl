...
set design enqueue_agent
set top enqueue_agent
...
read_verilog "./hdl/enqueue_agent.v"
...
set_property value {8} [ipx::get_user_parameters C_S_AXI_ADDR_WIDTH]
set_property value_format {long} [ipx::get_user_parameters C_S_AXI_ADDR_WIDTH]

ipx::add_user_parameter {QUEUE_NUM} [ipx::current_core]
set_property value_resolve_type {user} [ipx::get_user_parameters QUEUE_NUM]
set_property display_name {QUEUE_NUM} [ipx::get_user_parameters QUEUE_NUM]
set_property value {5} [ipx::get_user_parameters QUEUE_NUM]
set_property value_format {long} [ipx::get_user_parameters QUEUE_NUM]
