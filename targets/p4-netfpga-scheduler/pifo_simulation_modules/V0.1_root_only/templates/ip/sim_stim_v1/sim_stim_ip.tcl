...
set design sim_stim_general
set top sim_stim_general
...
read_verilog "./sim_stim_general.v"
...
ipx::add_user_parameter {HAND_SHAKE} [ipx::current_core]
set_property value_resolve_type {user} [ipx::get_user_parameters HAND_SHAKE]
set_property display_name {HAND_SHAKE} [ipx::get_user_parameters HAND_SHAKE]
set_property value {1} [ipx::get_user_parameters HAND_SHAKE]
set_property value_format {bool} [ipx::get_user_parameters HAND_SHAKE]
