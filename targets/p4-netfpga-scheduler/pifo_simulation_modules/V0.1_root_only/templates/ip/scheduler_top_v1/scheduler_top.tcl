...
set design scheduler_top
set top scheduler_top
...
read_verilog "./hdl/scheduler_top_v0_2.v"
read_verilog "./hdl/cpu_sub.v"
read_verilog "./hdl/top_scheduler_cpu_defines.v"
...
set_property value {512} [ipx::get_user_parameters BUFFER_WORD_DEPTH]
set_property value_format {long} [ipx::get_user_parameters BUFFER_WORD_DEPTH]

ipx::add_user_parameter {PIFO_CALENDAR_DEPTH} [ipx::current_core]
set_property value_resolve_type {user} [ipx::get_user_parameters PIFO_CALENDAR_DEPTH]
set_property display_name {PIFO_CALENDAR_DEPTH} [ipx::get_user_parameters PIFO_CALENDAR_DEPTH]
set_property value {32} [ipx::get_user_parameters PIFO_CALENDAR_DEPTH]
set_property value_format {long} [ipx::get_user_parameters PIFO_CALENDAR_DEPTH]
