...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "STOP_FAIL" -parent ${Page_0}
...
proc update_PARAM_VALUE.STOP_FAIL { PARAM_VALUE.STOP_FAIL } {
	# Procedure called to update STOP_FAIL when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.STOP_FAIL { PARAM_VALUE.STOP_FAIL } {
	# Procedure called to validate STOP_FAIL
	return true
}


proc update_MODELPARAM_VALUE.STOP_FAIL { MODELPARAM_VALUE.STOP_FAIL PARAM_VALUE.STOP_FAIL } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.STOP_FAIL}] ${MODELPARAM_VALUE.STOP_FAIL}
}
