...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "HAND_SHAKE" -parent ${Page_0}
...
proc update_PARAM_VALUE.HAND_SHAKE { PARAM_VALUE.HAND_SHAKE } {
	# Procedure called to update HAND_SHAKE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.HAND_SHAKE { PARAM_VALUE.HAND_SHAKE } {
	# Procedure called to validate HAND_SHAKE
	return true
}
...
proc update_MODELPARAM_VALUE.HAND_SHAKE { MODELPARAM_VALUE.HAND_SHAKE PARAM_VALUE.HAND_SHAKE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.HAND_SHAKE}] ${MODELPARAM_VALUE.HAND_SHAKE}
}
