...
(
    // Data Path I/O
    input                                             tuple_in_my_extern_calc_input_VALID,
    input   [INPUT_WIDTH-1:0]                         tuple_in_my_extern_calc_input_DATA,
    output                                             tuple_out_my_extern_calc_output_VALID,
    output  [RESULT_WIDTH-1:0]                         tuple_out_my_extern_calc_output_DATA,
...
assign {w_req_valid, w_div_output_port, w_div_class_id, w_div_class_weight, w_div_pkt_size, w_div_calc_type} = tuple_in_my_extern_calc_input_DATA;
...
assign w_div_out_valid = tuple_in_my_extern_calc_input_VALID;
assign w_div_out_quotient = 1;
assign w_div_out_remain = 1;
...
// WFQ ENGINE
    ...
    assign tuple_out_my_extern_calc_output_VALID = r_output_valid;
    assign tuple_out_my_extern_calc_output_DATA = r_output_data;
endmodule
