...
def test_fixed_size_senario():
	# print "configuaring  size data {}".format(size)

	for i in range(50):
		send_pkt("01:33:33:33:33:01", "03:00:00:00:00:03",'nf1','nf2',128, i) # mice
		send_pkt("01:44:44:44:44:01", "04:00:00:00:00:04",'nf0','nf2',512, i) # elephant

	write_pcap_files()

# # test_fixed_size_senario(256)
test_fixed_size_senario()
