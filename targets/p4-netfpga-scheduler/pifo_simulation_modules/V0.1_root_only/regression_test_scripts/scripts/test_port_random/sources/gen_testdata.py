...
for i in range(100):
	dport = random.randrange(0, 4)  
	sport = random.randrange(0, 4)

	dport_name = port_map[dport]
	sport_name = port_map[sport]
	dmac_name = l2_dmac[dport]
	smac_name = l2_dmac[sport]
	
	send_pkt(smac_name, dmac_name, sport_name, dport_name, 128, i)
