...
sed -i '/.tuple_out_rankcalc_wrr_calc_output_DATA/a .wire_in_last_pkt_info0(last_pkt_info0),' SimpleSumeSwitch.v
sed -i '/.tuple_out_rankcalc_wrr_calc_output_DATA/a .wire_in_last_pkt_info1(last_pkt_info1),' SimpleSumeSwitch.v
sed -i '/.tuple_out_rankcalc_wrr_calc_output_DATA/a .wire_in_last_pkt_info2(last_pkt_info2),' SimpleSumeSwitch.v
sed -i '/.tuple_out_rankcalc_wrr_calc_output_DATA/a .wire_in_last_pkt_info3(last_pkt_info3),' SimpleSumeSwitch.v
sed -i '/.tuple_out_rankcalc_wrr_calc_output_DATA/a .wire_in_last_pkt_info4(last_pkt_info4),' SimpleSumeSwitch.v
