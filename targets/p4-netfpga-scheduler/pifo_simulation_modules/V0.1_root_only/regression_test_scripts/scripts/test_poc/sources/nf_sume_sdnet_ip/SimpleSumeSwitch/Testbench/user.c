...
// enumeration
  #define TABLE_table_switch_mode 0
 #define TABLE_table_rank_calc_mode 1
 #define TABLE_table_l2_switch 2
 #define TABLE_table_l1_switch 3
 #define TABLE_table_wrr_class_lookup 4
 #define TABLE_table_strict_priority 5
