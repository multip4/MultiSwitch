...
// enumeration
  #define TABLE_table_l2_switch 0
 #define TABLE_table_l1_switch 1
 #define TABLE_table_strict_priority 2
 #define TABLE_table_switch_mode 3
 #define TABLE_table_rank_calc_mode 4
