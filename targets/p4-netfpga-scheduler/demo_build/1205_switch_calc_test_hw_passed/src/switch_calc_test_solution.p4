...
control TopPipe(inout Parsed_packet p,
    ...
    action set_l2_action(bit<8> port_bit) {
        sume_metadata.dst_port = port_bit;

    }

    action set_l2_action_default() {
    ...
    table l2_forwarding{
        ...
        actions = {
            set_l2_action;
            set_l2_action_default;
        }
        size = 64;
        default_action = set_l2_action_default;
    }
