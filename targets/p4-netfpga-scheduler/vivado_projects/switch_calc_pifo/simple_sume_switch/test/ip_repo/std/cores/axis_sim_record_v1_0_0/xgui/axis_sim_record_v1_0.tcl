...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "NOT_READY_COUNT" -parent ${Page_0}
  ipgui::add_param $IPINST -name "OUTPUT_FILE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "READY_COUNT" -parent ${Page_0}
...
proc update_PARAM_VALUE.NOT_READY_COUNT { PARAM_VALUE.NOT_READY_COUNT } {
	# Procedure called to update NOT_READY_COUNT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NOT_READY_COUNT { PARAM_VALUE.NOT_READY_COUNT } {
	# Procedure called to validate NOT_READY_COUNT
	return true
}
...
proc update_PARAM_VALUE.READY_COUNT { PARAM_VALUE.READY_COUNT } {
	# Procedure called to update READY_COUNT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.READY_COUNT { PARAM_VALUE.READY_COUNT } {
	# Procedure called to validate READY_COUNT
	return true
}
...
proc update_MODELPARAM_VALUE.READY_COUNT { MODELPARAM_VALUE.READY_COUNT PARAM_VALUE.READY_COUNT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.READY_COUNT}] ${MODELPARAM_VALUE.READY_COUNT}
}

proc update_MODELPARAM_VALUE.NOT_READY_COUNT { MODELPARAM_VALUE.NOT_READY_COUNT PARAM_VALUE.NOT_READY_COUNT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NOT_READY_COUNT}] ${MODELPARAM_VALUE.NOT_READY_COUNT}
}
