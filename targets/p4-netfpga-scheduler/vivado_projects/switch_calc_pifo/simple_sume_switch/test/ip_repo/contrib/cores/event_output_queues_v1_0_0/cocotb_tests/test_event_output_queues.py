...
def reset_dut(dut):
    ...
    dut.m_enq_event_rd <= 0
    dut.m_deq_event_rd <= 0
    dut.m_drop_event_rd <= 0
...
@cocotb.test()
def test_event_output_queues(dut):
    ...
    pkt_slave = AXI4StreamSlave(dut, 'm_axis_0', dut.axis_aclk, tready_delay=BP_COUNT, idle_timeout=IDLE_TIMEOUT)
