...
set design event_output_queues
set top event_output_queues
...
set_property value_resolve_type {user} [ipx::get_user_parameter NUM_PORTS [ipx::current_core]]
set_property display_name {NUM_PORTS} [ipx::get_user_parameter NUM_PORTS [ipx::current_core]]
set_property value {5} [ipx::get_user_parameter NUM_PORTS [ipx::current0_core]]
set_property value_format {long} [ipx::get_user_parameter NUM_PORTS [ipx::current_core]]
