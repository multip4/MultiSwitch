...
set_property -dict [list CONFIG.Full_Threshold_Assert_Value {13}] [get_ips fifo_generator_status]
set_property -dict [list CONFIG.Full_Threshold_Negate_Value {12}] [get_ips fifo_generator_status]
