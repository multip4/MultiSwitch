...
# add to modify user width (128->160)
#set_property -dict [list CONFIG.C_S_AXIS_TUSER_WIDTH {160}] [get_ips input_arbiter_ip]
# set_property -dict [list CONFIG.C_S_AXIS_TUSER_WIDTH {160}] [get_ips nf_sume_sdnet_ip]
#set_property -dict [list CONFIG.C_M_AXIS_TUSER_WIDTH {160}] [get_ips nf_sume_sdnet_ip]
# set_property -dict [list CONFIG.C_M_AXIS_TUSER_WIDTH {160}] [get_ips sss_output_queues_ip]

set_property -dict [list CONFIG.READY_COUNT {2} CONFIG.NOT_READY_COUNT {98}] [get_ips axis_sim_record_ip0]
...
#read_verilog "$::env(NF_DESIGN_DIR)/hw/hdl/dummy_queue.v"
